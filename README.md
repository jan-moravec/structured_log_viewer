...
- [lnav](https://github.com/tstack/lnav) (BSD-2-Clause) — reference patterns for the built-in syslog / Apache regex templates
- [logstash-plugins/logstash-patterns-core](https://github.com/logstash-plugins/logstash-patterns-core) (Apache-2.0) — reference grok patterns informing the built-in regex registry
